...
class Member extends Model
{
    ...
    protected $fillable = [
        ...
        'FreeSessions',
        'Notes',
        'StartedBranchID',   // This field remains and is used to reference the branch.
        // If you have a separate column for current branch, include it too:
        'BranchID',          // Optional: use if you maintain both columns.
        'MemberStatusID',
    ];
